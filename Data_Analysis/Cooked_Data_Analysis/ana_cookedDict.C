...
"/Users/gsmith23/Desktop/Watchman/Testing/Wavedump_Wrapper/Data_Analysis/Cooked_Data_Analysis/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("ana_cookedDict",
        ...
        TriggerDictionaryInitialization_ana_cookedDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
