...
void TConvert::PreLoop(){
  ...
  minTTT  = 0.0;
  minTTT -= rangeTTT/nBinsTTT; 
  maxTTT += rangeTTT/nBinsTTT;
...
/*    TH2F * h2 = new TH2F("h2","h2;Event;trig time tag", */
/* 			400,0.,4000000,  */
/* 			1024,INT_MIN,INT_MAX); */
...
//     printf("\n peak time   = %f \n", Get_peakT_ns(ADC));
    ...
    //h2->Fill(HEAD[4],trigTimeTag,Get_peakT_ns(ADC));
